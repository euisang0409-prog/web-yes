...
# show index from 테이블
# 제약조건에 부여된 이름 찾기 KEY_NAME 부분이 이름임
...
# default : 컬럼에 값이 아예 주어지지 않았을 때 자동으로 들아가는 기본값을 정하는 규칙
...
# CHECK 제약조건은 값이 들어올 때 검사

# NULL이 들어오게 되면 비교자체가 안된다.
# CHECK는 FALSE는 막는데 UNKNOWN은 통과
