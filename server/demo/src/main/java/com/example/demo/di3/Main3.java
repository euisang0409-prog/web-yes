...
////			생성할 수 있는 상태로 만든다.
//			
//			ClassLoader classLodaer = AppContext.class.getClassLoader();
//			
////			클래스 경로 상의 모든 클래스를 탐색하고 사용할 수 있게 도와준다.
//			ClassPath classPath = ClassPath.from(classLodaer);
//			
////			지정한 패키지내의 모든 클래스 정보를 가져와라 
//			Set<ClassPath.ClassInfo> set = classPath.getTopLevelClasses("com.example.demo.di3");
//			
//			for(ClassPath.ClassInfo classInfo : set) {
//				
////				현재의 ClassInfo classInfo 객체를 실제로 로드된 클래스(Class)로 변환한다.
//				
